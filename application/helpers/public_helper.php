...
function app_info($key=''){
	$app_info = [
		'title' => 'Aplikasi DPBT Survey Surat Ijo',
		'description' => 'Aplikasi DPBT Survey Surat Ijo',
		'name' => 'Aplikasi DPBT Survey Surat Ijo',
		'shortname' => 'DPBT Survey',
		'client' => [
			'shortname' => 'DPBT',
			'fullname' => 'Dinas Pengelolaan Bangunan dan Tanah Pemerintah Kota Surabaya',
			'city' => 'Kota Surabaya',
			'category' => 'Government'
		],
		'year' => '2018',
		'copyright' => 'Dinas Pengelolaan Bangunan dan Tanah Pemerintah Kota Surabaya',
		'vendor' => [
